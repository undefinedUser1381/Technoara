...
export default function ProductsTable() {
  ...
  return (
    <div className='rounded-2xl overflow-hidden border dark:border-gray-500'>
       <Table className="overflow-scroll lg:overflow-hidden dark:border-gray-700 rounded-2xl">
