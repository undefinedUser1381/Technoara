...
export default function TicketsModal() {
  return (
    <div className='fixed transition-all duration-300 top-0 left-0 right-0 bottom-0 z-30 bg-[rgba(0,0,0,0.7)] cursor-pointer w-full h-full flex items-center justify-center'>
      <div className='w-[75%] h-[40rem] overflow-y-auto bg-white dark:bg-[#111827] p-3 rounded-lg cursor-auto'>
        ...
        <div className='flex flex-col lg:flex-row items-center justify-between gap-3 mt-8'>
        <div className='flex items-center justify-start p-2 rounded-lg w-full lg:w-[35%] dark:bg-[#1B2631] bg-[#F9FAFB] gap-3'>
